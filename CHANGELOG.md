...
* Support all python versions ([1e8f008](https://github.com/de-it-krachten/ansible-role-python/commit/1e8f0081e9268beabd4c559e4cb571931832a5ff))

# [1.16.0](https://github.com/de-it-krachten/ansible-role-python/compare/v1.15.0...v1.16.0) (2025-03-14)


### Features

* Add option to create empty venv ([d57ff31](https://github.com/de-it-krachten/ansible-role-python/commit/d57ff312940643629b4cf806160d701049a21335))
...
* Add support for Ubuntu 24.04 LTS + Fedora 40 ([e425d1f](https://github.com/de-it-krachten/ansible-role-python/commit/e425d1fad1e95c61c0fa6a8adca852628b6be809))

## [1.13.1](https://github.com/de-it-krachten/ansible-role-python/compare/v1.13.0...v1.13.1) (2024-04-12)


### Bug Fixes

* Add support for package removal ([f146130](https://github.com/de-it-krachten/ansible-role-python/commit/f146130b5187fcc916c0a9668d8a0770b8322a7b))
